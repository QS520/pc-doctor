...
/// 禁用服务
#[tauri::command]
pub fn disable_service(name: String) -> ServiceOperationResult {
    #[cfg(windows)]
    {
...
/// 启用服务（设置为手动）
#[tauri::command]
pub fn enable_service(name: String) -> ServiceOperationResult {
    #[cfg(windows)]
    {
        let output = std::process::Command::new("sc")
...
/// 启动服务
#[tauri::command]
pub fn start_service(name: String) -> ServiceOperationResult {
    #[cfg(windows)]
    {
        let output = std::process::Command::new("sc")
            .args(["start", &name])
...
/// 停止服务
#[tauri::command]
pub fn stop_service(name: String) -> ServiceOperationResult {
    #[cfg(windows)]
    {
        let output = std::process::Command::new("sc")
            .args(["stop", &name])
