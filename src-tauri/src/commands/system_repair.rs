...
#[tauri::command]
pub fn run_chkdsk(drive: Option<String>) -> RepairResult {
...
/// 检查磁盘健康状态 (通过 WMI/S.M.A.R.T)
#[tauri::command]
pub fn check_disk_health() -> Vec<DiskHealthInfo> {
