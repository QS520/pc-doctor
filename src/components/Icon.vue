...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'broom'">
      <path d="m14 8-2-2" />
      <path d="m17 5-2-2" />
      <path d="M3 21s3-1 5-3 3-3 3-3l6-6 5 5-6 6s-1 1-3 3-3 5-3 5Z" />
      <path d="m9 11 4 4" />
    </template>
    ...
    <template v-else-if="name === 'motherboard'">
      <path d="M4 9a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2Z" />
      <path d="M4 3V1" />
      <path d="M8 7h2" />
      <path d="M4 9v2" />
      <path d="M14 22a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2Z" />
      <path d="M14 10h6" />
      <path d="M14 14h6" />
      <path d="M14 18h6" />
      <path d="M18 6V4" />
      <path d="M2 14h8" />
      <path d="M2 18h8" />
      <path d="M2 22h6a2 2 0 0 0 2-2" />
      <path d="M2 22a2 2 0 0 1-2-2v-3" />
    </template>
    ...
    <template v-else-if="name === 'thermometer'">
      <path d="M14 4v10.54a4 4 0 1 0 4 0V4a2 2 0 0 0-4 0Z" />
      <path d="M14 10a2 2 0 0 0-4 0v10.54a4 4 0 1 0 4 0Z" />
    </template>
    ...
    <template v-else-if="name === 'battery-charging'">
      <path d="M14 7h2a2 2 0 0 1 2 2v6c0 1-1 2-2 2h-3" />
      <path d="M7 7H4c-1 0-2 1-2 2v6c0 1 1 2 2 2h3" />
      <path d="M12 8 9 12h4l-3 4" />
      <path d="M22 11v2" />
    </template>
    ...
    <template v-else-if="name === 'fan'">
      ...
      <path d="M14 2v4.5" />
      <path d="M12 2v6" />
      <path d="M12 12c-3.866 0-7 3.134-7 7s3.134 7 7 7 7-3.134 7-7" />
      <path d="M12 12c0-3.866 3.134-7 7-7" />
      <path d="M12 12c3.866 0 7 3.134 7 7" />
    </template>
    <template v-else-if="name === 'plug'">
      <path d="M12 22v-5" />
      <path d="M9 8V2" />
      <path d="M15 8V2" />
      <path d="M18 8v3a3 3 0 0 1-3 3h0a3 3 0 0 1-3-3V8h6Z" />
      <path d="M9 8v3a3 3 0 0 0 3 3" />
    </template>
